const translations = {
  fr: {
    ...
    terrain: {
      card1title: "WordPress avancé",
      card1li1: "Thèmes custom de A à Z",
      card1li2: "Hooks, actions, filters",
      card1li3: "Custom post types & taxonomies",
      card1li4: "<code>wp_enqueue</code>, menus, widgets",
      card1li5: "Développement multisite",
      card2title: "PHP & Templates",
      card2li1: "Templates page, single, archive",
      card2li2: "Boucle WP & <code>WP_Query</code> sur mesure",
      card2li3: "Shortcodes & endpoints AJAX",
      card2li4: "<code>esc_html</code>, <code>esc_url</code>, <code>esc_attr</code>",
      card2li5: "Contrôles conditionnels & includes",
      card3title: "ACF & Contenu flexible",
      card3li1: "<code>get_field()</code> / <code>the_field()</code>",
      card3li2: "Flexible Content (sections modulaires)",
      card3li3: "Repeater, galeries d'images",
      card3li4: "Options pages & champs conditionnels",
      card3li5: "<code>wp_get_attachment_image()</code>",
      card4title: "Front-end JS riche",
      card4li1: "jQuery, GSAP + ScrollMagic",
      card4li2: "Swiper, Owl Carousel",
      card4li3: "Magnific Popup / fslightbox",
      card4li4: "Lottie (animations SVG web)",
      card4li5: "Google Maps + MarkerClusterer",
      card5title: "E-commerce & Formulaires",
      card5li1: "WooCommerce — templates & hooks",
      card5li2: "Formidable Forms (logique métier)",
      card5li3: "Système inscriptions/événements custom",
      card5li4: "Tables MySQL sur mesure (<code>Rh00PCm_*</code>)",
      card5li5: "Validation & traitement serveur",
      card6title: "Build & Architecture CSS",
      card6li1: "SCSS modulaire (partials, mixins, variables)",
      card6li2: "Pipeline npm + Gulp → <code>style.css</code>",
      card6li3: "Laravel Mix + TailwindCSS",
      card6li4: "Assets compilés & optimisés (<code>assets/</code>)",
      card6li5: "Media-queries & composants réutilisables",
      card7title: "Multilingue & WPML",
      card7li1: "Sites FR / EN / NL avec WPML",
      card7li2: "Requêtes WPML-aware (post_meta)",
      card7li3: "Colonnes suffixées par langue",
      card7li4: "<code>__()</code> / <code>_e()</code> WordPress",
      card7li5: "Structure sémantique & SEO multilingue",
      card8title: "Intégrations & Sécurité",
      card8li1: "Google Maps API & ShareThis",
      card8li2: "Modals & overlays (<code>hs-overlay</code>)",
      card8li3: "Gestion <code>wp-config.php</code> (constantes, clés)",
      card8li4: "Sessions & chiffrement AES (formulaires)",
      card8li5: "Yoast SEO, plugins & performance"
    },
    portfolio: {
  ...
  en: {
    ...
    terrain: {
      card1title: "Advanced WordPress",
      card1li1: "Custom themes from scratch",
      card1li2: "Hooks, actions, filters",
      card1li3: "Custom post types & taxonomies",
      card1li4: "<code>wp_enqueue</code>, menus, widgets",
      card1li5: "Multisite development",
      card2title: "PHP & Templates",
      card2li1: "Page, single, archive templates",
      card2li2: "WP Loop & custom <code>WP_Query</code>",
      card2li3: "Shortcodes & AJAX endpoints",
      card2li4: "<code>esc_html</code>, <code>esc_url</code>, <code>esc_attr</code>",
      card2li5: "Conditional logic & PHP includes",
      card3title: "ACF & Flexible Content",
      card3li1: "<code>get_field()</code> / <code>the_field()</code>",
      card3li2: "Flexible Content (modular sections)",
      card3li3: "Repeater fields, image galleries",
      card3li4: "Options pages & conditional fields",
      card3li5: "<code>wp_get_attachment_image()</code>",
      card4title: "Rich front-end JS",
      card4li1: "jQuery, GSAP + ScrollMagic",
      card4li2: "Swiper, Owl Carousel",
      card4li3: "Magnific Popup / fslightbox",
      card4li4: "Lottie (SVG web animations)",
      card4li5: "Google Maps + MarkerClusterer",
      card5title: "E-commerce & Forms",
      card5li1: "WooCommerce — templates & hooks",
      card5li2: "Formidable Forms (business logic)",
      card5li3: "Custom registration/events system",
      card5li4: "Custom MySQL tables (<code>Rh00PCm_*</code>)",
      card5li5: "Server-side validation & processing",
      card6title: "Build & CSS Architecture",
      card6li1: "Modular SCSS (partials, mixins, variables)",
      card6li2: "npm + Gulp pipeline → <code>style.css</code>",
      card6li3: "Laravel Mix + TailwindCSS",
      card6li4: "Compiled & optimised assets (<code>assets/</code>)",
      card6li5: "Media-queries & reusable components",
      card7title: "Multilingual & WPML",
      card7li1: "FR / EN / NL sites with WPML",
      card7li2: "WPML-aware queries (post_meta)",
      card7li3: "Language-suffixed columns",
      card7li4: "<code>__()</code> / <code>_e()</code> WordPress",
      card7li5: "Semantic structure & multilingual SEO",
      card8title: "Integrations & Security",
      card8li1: "Google Maps API & ShareThis",
      card8li2: "Modals & overlays (<code>hs-overlay</code>)",
      card8li3: "<code>wp-config.php</code> management (keys, constants)",
      card8li4: "Sessions & AES encryption (forms)",
      card8li5: "Yoast SEO, plugins & performance"
    },
    portfolio: {
