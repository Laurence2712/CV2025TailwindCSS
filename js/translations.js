const translations = {
  fr: {
    ...
    sections: {
      ...
      portfolioLead: "Une sélection de sites sur lesquels j'ai travaillé — en agence chez Paf! Design ou en indépendante.",
    ...
    about: {
      ...
      stat1: "années d'expérience en développement web",
      statCoffeeNum: "7 300+",
      statCoffeeLabel: "",
      statCoffee: "☕",
      stat3: "Diplômée en tant que Web Developer — EPFC, Bruxelles",
    ...
    formation: {
      ...
      desc1: "Formation certifiante en développement web.<p class=\"tl-stack-line\" style=\"margin-top:10px\"><strong>Technologies</strong> — HTML5 · CSS3 · JavaScript · PHP · jQuery · WordPress · Bootstrap · Photoshop</p>"
    },
    experience: {
      date1: "2023 – Présent",
    ...
    portfolio: {
      ...
      chiroDesc: "Site vitrine pour un cabinet de chiropraxie à Mons",
      chiroCat: "Site vitrine",
      hospelType: "Site institutionnel",
      hospelTitle: "Notaire Hospel",
      hospelDesc: "Thème WordPress custom en agence (Paf!) — Tailwind via Laravel Mix, carousel Swiper, champs ACF, intégration Google Maps.",
      hospelCat: "Site corporate",
      memisaType: "Site associatif",
      memisaTitle: "Memisa",
      memisaDesc: "Thème WordPress custom en agence (Paf!) - GSAP,  jQuery, WPML, ACF.",
      memisaCat: "Site ONG / associatif",
      courriereType: "Site événementiel",
      courriereTitle: "Château de Courrière",
      courriereDesc: "Thème WordPress custom en agence (Paf!) — site vitrine pour un château de caractère en Wallonie.",
  ...
  en: {
    ...
    sections: {
      ...
      portfolioTitle: "Portfolio",
      portfolioLead: "A selection of sites I've worked on — at Paf! Design agency or as an independent.",
    ...
    formation: {
      ...
      desc1: "Certified web development program.<p class=\"tl-stack-line\" style=\"margin-top:10px\"><strong>Technologies</strong> — HTML5 · CSS3 · JavaScript · PHP · jQuery · WordPress · Bootstrap · Photoshop</p>"
    },
    experience: {
      date1: "2023 – Present",
    ...
    portfolio: {
      ...
      chiroDesc: "Website showcasing a chiropractic practice in Mons",
      chiroCat: "Showcase website",
      hospelType: "Institutional Website",
      hospelTitle: "Notary Hospel",
      hospelDesc: "Custom WordPress theme at Paf! — Tailwind build via Laravel Mix, Swiper carousel, ACF fields and Google Maps.",
      hospelCat: "Corporate website",
      memisaType: "Non-profit Website",
      memisaTitle: "Memisa",
      memisaDesc: "Custom WordPress theme at Paf! - GSAP, jQuery, WPML, ACF.",
      memisaCat: "NGO website",
      courriereType: "Event Website",
      courriereTitle: "Château de Courrière",
      courriereDesc: "Custom WordPress theme at Paf! — showcase website for a character château in Wallonia.",
