const translations = {
  fr: {
    ...
    services: {
      ...
      formSubtitle: "Remplissez ce formulaire et je vous réponds rapidement.",
      formName: "Votre nom",
      formEmail: "Votre email",
      formService: "Service qui vous intéresse",
      formServiceDefault: "Choisissez un service…",
      ...
      formSuccess: "Message envoyé ! Je vous réponds rapidement.",
  ...
  en: {
    ...
    services: {
      ...
      formSubtitle: "Fill in this form and I'll get back to you quickly.",
      formName: "Your name",
      formEmail: "Your email",
      formService: "Service you're interested in",
